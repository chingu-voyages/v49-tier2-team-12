    ...
    return (
        <div className="flex flex-col lg:flex-row pb-20 pt-16 -z-10 ">
            <div className="lg:w-1/2 flex flex-col items-start justify-center">
                ...
                <div className="flex flex-col items-center justify-center mx-auto rounded-lg box-shadow p-4 transform transition-transform hover:-translate-y-0.5 hover:-translate-x-0.5">
