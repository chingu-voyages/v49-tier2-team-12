        ...
        <div className="w-full flex flex-col lg:flex-row justify-between gap-3">
            <div className="w-1/2">
                ...
                />
                    <button
                        type="submit"
                        className="w-full h-12 text-gray-950 bg-yellow-300 py-2 rounded-sm"
                        style={{backgroundColor: recommendation?.compatibleColors[1].code}}
                    >
            ...
            {
                recommendation ?
                    <div className="w-1/2 text-black p-4 border border-gray-300 rounded-sm  shadow-sm">
                    ...
                    </div> : <div className="text-center flex-1 text-gray-500">Responses goes here</div>
            }
        </div>
    )
}
